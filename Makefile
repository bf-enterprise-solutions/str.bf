...
rev-files = length.rev.bf clip.rev.bf concatenate.rev.bf interleave.rev.bf deinterleave.rev.bf repeat.rev.bf duplicate.rev.bf swap.rev.bf reverse.rev.bf copy.rev.bf equal.rev.bf hash.rev.bf
rev: $(rev-files)
min-files = length.min.bf clip.min.bf concatenate.min.bf interleave.min.bf deinterleave.min.bf repeat.min.bf duplicate.min.bf swap.min.bf reverse.min.bf copy.min.bf equal.min.bf hash.min.bf  length.rev.min.bf clip.rev.min.bf concatenate.rev.min.bf interleave.rev.min.bf deinterleave.rev.min.bf repeat.rev.min.bf duplicate.rev.min.bf swap.rev.min.bf reverse.rev.min.bf copy.rev.min.bf equal.rev.min.bf hash.rev.min.bf
min: rev $(min-files)
